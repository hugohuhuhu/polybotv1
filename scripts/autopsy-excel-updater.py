...
CANDIDATE_COLUMNS = [
    ...
    "maker_entry_bid",
    "taker_fallback_price",
    "taker_fallback_trigger",
    "taker_fallback_eligible",
    "taker_fallback_reasons",
    "size",
    "notional",
    "best_bid",
    "best_ask",
        ...
        merged.update(
            {
                ...
                "entry_execution_mode": raw.get("entry_execution_mode"),
                "post_only": raw.get("post_only"),
                "order_type": raw.get("order_type"),
                "maker_entry_bid": raw.get("maker_entry_bid"),
                "taker_fallback_price": raw.get("taker_fallback_price"),
                "taker_fallback_trigger": raw.get("taker_fallback_trigger"),
                "taker_fallback_eligible": raw.get("taker_fallback_eligible"),
                "taker_fallback_reasons": raw.get("taker_fallback_reasons"),
