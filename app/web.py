        ...
        "groups": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"label": "周末輕量模式", "value": "開" if settings.near_close_weekend_mode_active() else "關"},
                    {"label": "周末模式設定", "value": "啟用" if settings.near_close_weekend_mode_enabled else "停用"},
                    {"label": "paper signals 門檻", "value": settings.near_close_min_paper_signals_for_live},
                    {"label": "下單大小", "value": settings.effective_near_close_order_size(), "unit": "pUSD"},
                    {"label": "同市場曝險", "value": settings.effective_near_close_max_market_exposure(), "unit": "pUSD"},
                    {"label": "總曝險", "value": settings.effective_near_close_max_total_exposure(), "unit": "pUSD"},
                    ...
                    {"label": "最大 spread", "value": settings.effective_near_close_max_spread()},
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"label": "最低 ask", "value": settings.effective_near_close_min_best_ask("crypto_updown")},
                    {"label": "最低 midpoint", "value": settings.effective_near_close_min_midpoint("crypto_updown")},
                    {"label": "最大 spread", "value": settings.effective_near_close_max_spread("crypto_updown")},
                    {"label": "最高 bid", "value": settings.near_close_crypto_updown_max_bid_price},
                    {"label": "進場價下限", "value": settings.effective_near_close_min_entry_price("crypto_updown")},
    ...
    def fallback_dashboard_payload(
        *,
        ...
        return {
            ...
            "cancel_autopsy": {"rows": [], "by_reason": [], "generated_at": None},
