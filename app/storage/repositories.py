...
class ScannerRepository:
    ...
    def _candidate_autopsy_snapshot(self, opportunity: Opportunity, details: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "last_trade_price": self._json_float(details, "last_trade_price"),
            "last_trade_at": details.get("last_trade_at"),
            "last_trade_age_sec": self._json_float(details, "last_trade_age_sec"),
            "last_trade_side": details.get("last_trade_side"),
            "crypto_spot_price": self._json_float(details, "crypto_spot_price"),
            "crypto_spot_updated_at": details.get("crypto_spot_updated_at"),
            "crypto_spot_age_sec": self._json_float(details, "crypto_spot_age_sec"),
            ...
            "crypto_momentum_short_bps": self._json_float(details, "crypto_momentum_short_bps"),
            "crypto_momentum_long_bps": self._json_float(details, "crypto_momentum_long_bps"),
            ...
            "taker_only_enabled": details.get("taker_only_enabled"),
